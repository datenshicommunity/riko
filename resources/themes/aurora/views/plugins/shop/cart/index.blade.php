    ...
    <div class="container content">
        <div class="page-container">
            <div class="page-container-content">
                <h1 class="page-container-title">{{ trans('shop::messages.cart.title') }}</h1>
                ...
                @if(! $cart->isEmpty())
                        ...
                        <table class="table cart-items">
                            ...
                            @foreach($cart->content() as $cartItem)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('shop.cart.remove', $cartItem->id) }}" style="margin: 0" class="btn btn-sm btn-danger" title="{{ trans('messages.actions.delete') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('shop.cart.coupons.add') }}" method="POST" class="form-inline mb-5">
                                @csrf

                                <div>
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" placeholder="Code" id="code" name="code" value="{{ old('code') }}">
                                ...
                                <button type="submit" class="btn btn-primary mx-2" style="margin-top: 0">{{ trans('messages.actions.add') }}</button>
                            </form>
                        </div>
                    </div>
